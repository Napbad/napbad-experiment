...
public class JwtUtil {
    public static String createJWT(String secretKey, long ttlMillis, HashMap<String, Object> claims) {
    ...
    public static Claims parseJWT(String secretKey, String token) {
        return (Claims)Jwts.parser().setSigningKey(secretKey.getBytes(StandardCharsets.UTF_8)).parseClaimsJws(token).getBody();
    }
